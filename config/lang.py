LANG_DICT = {
    "ENG": {
		...
		"bottom_pass_text": "...",
		"tooltip_label_pass": "Leave it blank for no password. Enter a single password or password text (one per line), e.g., Abc12# or D:/pass.txt",
		...
		"tooltip_label_warn": "Hardware resources will be checked before decompression begins. operation may be denied if resources are insufficient. Enabling this option will disable the check",
		...
		"tooltip_label_logl": "Controls the level of logs written into the log file. After modifying log-related options, the program needs to be restarted to take effect",
		...
		"tooltip_label_logc": "Number of log files to keep on disk",
		...
		"tooltip_label_xcld": "Directories to be deleted, leave blank to disable. Enter a single directory name or directory name text",
		"tooltip_bottom_xcld": "Select a text file with  directory name list",
		"label_xclf_text": "Delete Files:  ",
		"tooltip_label_xclf": "Files to be deleted, leave blank to disable. Enter a single file name or file name text",
		"tooltip_bottom_xclf": "Select a text file with file name list",
		"log_area_title": "Watching Logs",
		...
		"extra_info_start": "{}Start running EX{}",
		"extra_xcld_info": "Deleted {1} junk directories in {0}.\n",
		"extra_xclf_info": "Deleted {1} junk files in {0}.\n",
		"extra_is_redundant_info": "Deleted {1} redundant directories in {0}.\n",
		"extra_is_empty_info": "Deleted {1} empty directories in {0}.\n",
		"extra_info_done": "{}Run complete EX{}",
		"extra_bottom_run_text": "Running...",
		"main_info_start": "{}Extracting files{}",
		"main_no_path_zip_warning": "Cannot proceed. Please enter the extraction directory",
		...
		"main_path_dest_error_msg": "Runtime error. Failed to create destination directory {}. Directory name should not contain prohibited special characters.",
		...
		"disk_free_warning": "The current disk free space is lower than the compressed file size. Continuing the execution may result in:\nSystem errors, failed extraction, and other unknown errors\n\nChoosing to ignore warnings will skip the disk free space check",
		"cpu_usage_warning": "The current CPU usage is above 50%. Continuing the execution may result in:\nSystem freeze, failed extraction, and other unknown errors\n\nChoosing to ignore the warning will skip the CPU usage check",
		"memory_usage_warning": "The current memory usage is above 50%. Continuing the execution may result in:\nSystem freeze, failed extraction, and other unknown errors\n\nChoosing to ignore the warning will skip the memory usage check",
		"main_info_done": "{}Finished!{}\nTotal compressed files: {} \nFailed extractions: {} \nSuccessful extractions: {} \nTotal compressed file size: {} \nProcesses: {} \nTime elapsed: {} \nProcessing speed: {}",
		"main_info_done_msg": "Finished!\nTotal compressed files: {} \nFailed extractions: {} \nSuccessful extractions: {} \nTotal compressed file size: {} \nProcesses: {} \nTime elapsed: {} \nProcessing speed: {}",
		"main_error": "{}An error occurred. Error message: {}\n{}",
		"main_error_msg": "An error occurred. Please submit a issue on GitHub",
		"test2": "啊啊啊啊啊啊啊啊",
		"test3": "啊啊啊啊啊啊啊啊"
    },
    "CHS": {
		...
		"memory_usage_warning": "目前内存使用率大于 50%，继续执行可能导致：\n系统卡死、解压失败、其他程序异常等未知错误\n\n打开忽略警告，可以跳过内存使用率检查",
