LANG_DICT = {
    "ENG": {
		...
		"format_size_typeerror": "The argument is not a number!",
		"format_size_valueerror": "The argument must be greater than zero",
		"second": "seconds",
		"minute": "minutes",
		"hour": "hours",
		"s": "s",
    ...
    "CHS": {
		...
		"format_size_typeerror": "参数不是数字!",
		"format_size_valueerror": "参数必须大于零",
		"second": "秒",
		"minute": "分钟",
		"hour": "小时",
		"s": "秒",
