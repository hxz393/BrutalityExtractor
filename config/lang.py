LANG_DICT = {
    "ENG": {
		...
		"path_dest_warning": "{}Unable to continue. Please enter the destination directory{}",
		"path_dest_warning_msg": "Please enter the destination directory",
    ...
    "CHS": {
		...
		"path_dest_warning": "{}无法继续运行。请输入目标目录{}",
		"path_dest_warning_msg": "请输入目标目录",
